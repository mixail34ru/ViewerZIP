...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "stable"
  WORKING_DIRECTORY "C:/Users/Michael/Documents/QtProjects/ViewerZIP/minizip-ng/third_party/zlib"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"stable\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Michael/Documents/QtProjects/ViewerZIP/minizip-ng/third_party/zlib'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Michael/Documents/QtProjects/ViewerZIP/minizip-ng/third_party/zlib'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
